...
//     // Check đường đi chữ Z nằm dọc (lật chữ Z sang phải/trái một góc 90 dộ đều
//     // được) và check luôn được chữ L
...
//         if (CheckZHorizontal(pMinX, pMaxX, board)) return true;
//     }
...
//     if ((p1.y == height - 1 || p1.y == 0) && (p1.y == p2.y)) return true;
...
//             else if (CheckU_Right(pMinY, pMaxY, board))
//                 return true;
//         }
//     }
